...
export async function GET(
  ...
  try {
    ...
    if (booking.patientId) {
      // Yeh booking ek registered patient ki hai —
      // sirf wahi patient (ya valid token wala) isse dekh sakta hai
      if (!token) {
        return NextResponse.json(
          {
            success: false,
    ...
    // Agar booking.patientId null hai (guest/emergency booking),
    // to koi login check nahi — koi bhi is bookingId se track kar sakta hai
