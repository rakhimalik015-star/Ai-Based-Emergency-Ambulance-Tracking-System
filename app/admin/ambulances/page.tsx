    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#070A12]">
        <div className="text-center">
          ...
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl border border-cyan-400/20 bg-cyan-400/4">
    ...
    <div className="min-h-screen bg-[#070A12] text-slate-200">
      ...
      <div className="mx-auto max-w-[1550px] px-5 py-8 sm:px-7 lg:px-10">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            ...
            <Link
              ...
              className="group flex w-fit items-center gap-3 rounded-xl bg-linear-to-r from-violet-500 to-cyan-500 px-5 py-3 text-xs font-bold uppercase tracking-[0.12em] text-white shadow-lg shadow-cyan-500/10 transition hover:scale-[1.02] hover:shadow-cyan-500/20"
            >
        ...
        <div className="mb-7 grid grid-cols-2 gap-3 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border border-white/6 bg-[#0C111B] p-5">
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-violet-400/15 bg-violet-400/5 text-lg">
                🚑
              </div>
          ...
          <div className="rounded-2xl border border-lime-400/10 bg-[#0C111B] p-5">
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-lime-400/15 bg-violet-400/5">
          ...
          <div className="rounded-2xl border border-amber-400/10 bg-[#0C111B] p-5">
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-amber-400/15 bg-violet-400/5">
                ◷
              </div>
          ...
          <div className="rounded-2xl border border-rose-400/10 bg-[#0C111B] p-5">
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-rose-400/15 bg-violet-400/5">
                !
              </div>
        ...
        <div className="mb-6 rounded-2xl border border-white/6 bg-[#0C111B] p-4">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="rounded-xl border border-cyan-400/10 bg-cyan-400/3 px-4 py-2.5">
              ...
              {search && (
                <button
                  onClick={() => setSearch("")}
                  className="rounded-xl border border-white/6 px-4 py-2.5 text-[10px] font-semibold text-slate-500 transition hover:border-cyan-400/20 hover:text-cyan-300"
                >
                  Clear
                </button>
              )}
        ...
        <div className="overflow-hidden rounded-2xl border border-white/6 bg-[#0C111B]">

          {/* TABLE HEADER */}

          <div className="flex flex-col justify-between gap-3 border-b border-white/6 px-5 py-5 sm:flex-row sm:items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="rounded-full border border-violet-400/10 bg-violet-400/4 px-2 py-1 text-[8px] font-bold uppercase tracking-[0.15em] text-violet-300">
                  Fleet Control
                </span>
          ...
          <div className="overflow-x-auto">
            ...
            <table className="w-full max-w-275">

              <thead>

                <tr className="border-b border-white/6 bg-[#090D15]">
              ...
              <tbody>
                ...
                {filteredAmbulances.length > 0 ? (
                  ...
                  filteredAmbulances.map((ambulance) => (
                    ...
                    <tr
                      key={ambulance.id}
                      className="group border-b border-white/4 transition-colors hover:bg-white/2"
                    >
                      ...
                      <td className="px-5 py-5">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-cyan-400/15 bg-cyan-400/5 text-lg">
                            🚑
                          </div>
                      ...
                      <td className="px-5 py-5">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex h-9 w-9 items-center justify-center rounded-full border border-violet-400/15 bg-violet-400/5 text-xs font-bold text-violet-300">
                      ...
                      <td className="px-5 py-5">
                        ...
                        <span className="inline-flex items-center gap-2 rounded-xl border border-white/[0.07] bg-white/2 px-3 py-2 text-xs font-medium text-slate-400">
                      ...
                      <td className="px-5 py-5">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Link
                            ...
                            className="rounded-xl border border-cyan-400/15 bg-cyan-400/4 px-4 py-2 text-[9px] font-bold uppercase tracking-[0.12em] text-cyan-300 transition hover:border-cyan-400/30 hover:bg-cyan-400/8"
                          >
                            Edit
                          </Link>
                          ...
                          <button
                            ...
                            className="rounded-xl border border-rose-400/15 bg-rose-400/4 px-4 py-2 text-[9px] font-bold uppercase tracking-[0.12em] text-rose-300 transition hover:border-rose-400/30 hover:bg-rose-400/8 disabled:cursor-not-allowed disabled:opacity-40"
                          >
                            {deletingId === ambulance.id
                              ? "Deleting..."
                              : "Delete"}
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-cyan-400/10 bg-cyan-400/4 text-2xl">
                        🚑
                      </div>
                      ...
                      {search ? (
                        <button
                          onClick={() => setSearch("")}
                          className="mt-5 rounded-xl border border-cyan-400/15 bg-cyan-400/4 px-4 py-2.5 text-[10px] font-semibold uppercase tracking-wider text-cyan-300 transition hover:bg-cyan-400/10"
                        >
                          Clear Search
                        </button>
                      ) : (
                        <Link
                          href="/admin/ambulances/add"
                          className="mt-5 inline-flex rounded-xl bg-linear-to-r from-violet-500 to-cyan-500 px-5 py-2.5 text-[10px] font-bold uppercase tracking-wider text-white"
                        >
                          + Add First Ambulance
                        </Link>
                      )}
          ...
          <div className="flex flex-col justify-between gap-2 border-t border-white/6 px-5 py-4 text-[9px] uppercase tracking-[0.12em] text-slate-700 sm:flex-row">
